...
public enum ResourceUtil {;
    ...
    public static void addSingleChestModels(String texture, String chestName, RuntimeResourcePack pack) {
        pack.addModel(JModel.model().parent("block/template_chest_center").textures(withChestParticle(JModel.textures().var("chest", texture), chestName)), new ResourceLocation("block/" + chestName + "_center"));
        pack.addModel(JModel.model().parent("block/template_chest_center_lid").textures(withChestParticle(JModel.textures().var("chest", texture), chestName)), new ResourceLocation("block/" + chestName + "_center_lid"));
        pack.addModel(JModel.model().parent("block/template_chest_center_trunk").textures(withChestParticle(JModel.textures().var("chest", texture), chestName)), new ResourceLocation("block/" + chestName + "_center_trunk"));
    }

    public static void addDoubleChestModels(String leftTex, String rightTex, String chestName, RuntimeResourcePack pack) {
        pack.addModel(JModel.model().parent("block/template_chest_left").textures(withChestParticle(JModel.textures().var("chest", leftTex), chestName)), new ResourceLocation("block/" + chestName + "_left"));
        pack.addModel(JModel.model().parent("block/template_chest_left_lid").textures(withChestParticle(JModel.textures().var("chest", leftTex), chestName)), new ResourceLocation("block/" + chestName + "_left_lid"));
        pack.addModel(JModel.model().parent("block/template_chest_left_trunk").textures(withChestParticle(JModel.textures().var("chest", leftTex), chestName)), new ResourceLocation("block/" + chestName + "_left_trunk"));
        pack.addModel(JModel.model().parent("block/template_chest_right").textures(withChestParticle(JModel.textures().var("chest", rightTex), chestName)), new ResourceLocation("block/" + chestName + "_right"));
        pack.addModel(JModel.model().parent("block/template_chest_right_lid").textures(withChestParticle(JModel.textures().var("chest", rightTex), chestName)), new ResourceLocation("block/" + chestName + "_right_lid"));
        pack.addModel(JModel.model().parent("block/template_chest_right_trunk").textures(withChestParticle(JModel.textures().var("chest", rightTex), chestName)), new ResourceLocation("block/" + chestName + "_right_trunk"));
    }
    ...
    public static void addChestBlockStates(String chestName, RuntimeResourcePack pack) {
        pack.addBlockState(
                ...
                ), new ResourceLocation(chestName)
        );
    }
    ...
    public static void addSignModels(String texture, String signName, String wallSignName, RuntimeResourcePack pack) {
        pack.addModel(JModel.model().parent(signAOSuffix("block/template_sign_0")).textures(withSignParticle(JModel.textures().var("sign", texture), signName)), new ResourceLocation("block/" + signName + "_0"));
        pack.addModel(JModel.model().parent(signAOSuffix("block/template_sign_22_5")).textures(withSignParticle(JModel.textures().var("sign", texture), signName)), new ResourceLocation("block/" + signName + "_22_5"));
        pack.addModel(JModel.model().parent(signAOSuffix("block/template_sign_45")).textures(withSignParticle(JModel.textures().var("sign", texture), signName)), new ResourceLocation("block/" + signName + "_45"));
        pack.addModel(JModel.model().parent(signAOSuffix("block/template_sign_67_5")).textures(withSignParticle(JModel.textures().var("sign", texture), signName)), new ResourceLocation("block/" + signName + "_67_5"));
        pack.addModel(JModel.model().parent(signAOSuffix("block/template_wall_sign")).textures(withSignParticle(JModel.textures().var("sign", texture), signName)), new ResourceLocation("block/" + wallSignName));
    }
    ...
    public static void addSignBlockStates(String signName, String wallSignName, RuntimeResourcePack pack) {
        ...
        pack.addBlockState(
                ...
                ), new ResourceLocation(wallSignName)
        );
    }
    ...
    public static void addBellBlockState(RuntimeResourcePack pack) {
        ...
        pack.addBlockState(JState.state(variant), new ResourceLocation("bell"));
    }
    ...
    public static void addBedModels(DyeColor bedColor, RuntimeResourcePack pack) {
        ...
        pack.addModel(
                ...
                new ResourceLocation("block/" + color + "_bed_head")
        );
        pack.addModel(
                JModel.model()
                        .parent(bedAOSuffix("block/template_bed_foot"))
                        .textures(withBedParticle(JModel.textures().var("bed", "entity/bed/" + color), color)),
                new ResourceLocation("block/" + color + "_bed_foot")
        );
    }
    ...
    public static void addBedBlockState(DyeColor bedColor, RuntimeResourcePack pack) {
        ...
        pack.addBlockState(JState.state(variant), new ResourceLocation(color + "_bed"));
    }
    ...
    public static void addShulkerBoxBlockStates(@Nullable DyeColor color, RuntimeResourcePack pack) {
        ...
        pack.addBlockState(JState.state(variant), new ResourceLocation(shulkerBoxStr));
    }
